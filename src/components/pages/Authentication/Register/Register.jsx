...
const Register = () => {
    ...
    const onSubmit = (data) => {
        ...
        alert("Registration attempt with: " + JSON.stringify(data, null, 2));
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <div className="flex justify-center mb-6">
                    <div className="bg-gray-200 rounded-full h-24 w-24 flex items-center justify-center text-gray-500">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <path fillRule="evenodd" d="M10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" /> {/* User head */}
                            <path fillRule="evenodd" d="M10 17a7 7 0 00-7 7H3a8 8 0 0116 0h-1a7 7 0 00-7-7z" clipRule="evenodd" /> {/* User body */}
                            <path d="M10 11a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1z" /> {/* Arrow up for upload */}
                        </svg>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            className={`shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline ${errors.password ? 'border-red-500' : ''}`}
                            {...register("password", {
                ...
                <p className="text-center text-gray-600 text-sm mb-4">
                    ...
                    <Link to={'/login'} href="#" className="font-bold text-lime-600 hover:text-lime-800">
                        Login
                    </Link>
                </p>
                ...
                >
                    <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" alt="Google logo" className="h-6 w-6" />
